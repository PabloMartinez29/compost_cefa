                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex space-x-2 items-center">
                                    ...
                                    <form id="admin-delete-form-{{ $organic->id }}" action="{{ route('admin.organic.destroy', $organic) }}" 
                                          method="POST" class="inline-flex items-center">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="inline-flex items-center text-red-500 hover:text-red-700" title="Delete"
                                                onclick="confirmDelete('admin-delete-form-{{ $organic->id }}')">
